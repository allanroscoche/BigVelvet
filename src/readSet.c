...
static void readFastXCSFasta(int fileType, SequencesWriter *seqWriteInfo, char *qualfilename1, char *filename1, char *qualfilename2, char *filename2, Category cat, IDnum * sequenceIndex, int min_qual)
{
  int tested=0;
	kseq_t *seq1, *seq2;
